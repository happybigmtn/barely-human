// Final Base Sepolia Deployment - Fixed Version
...
const CRAPS_SETTLEMENT_ADDRESS = "0xe156b261025e74a19b298c9d94260c744ae85d7f"; // Already deployed
...
async function main() {
  console.log("🚀 Final deployment continuation (Fixed)...\n");
  ...
  try {
    // First deploy VaultFactory since BotManager needs it
    ...
    // Now deploy BotManager with VaultFactory address
    console.log("📦 Deploying BotManager...");
    // Use temporary subscription ID since the actual one is too large for uint64
    const tempSubId = 1n; 
    ...
    // Update VaultFactory to use the real BotManager
    console.log("🔧 Updating VaultFactory with BotManager address...");
    ...
    console.log(`✅ VaultFactory updated\n`);
