#!/usr/bin/env node
// Barely Human - Create Deployer Wallet for Base Sepolia Deployment
...
console.log('🔐 Creating Deployer Wallet for Barely Human...\n');
...
console.log(`📂 Derivation Path: ${walletInfo.path}`);
console.log('\n═══════════════════════════════════════════════════════════════════\n');
...
// Save mnemonic to separate secure file
const mnemonicFile = path.join(outputDir, '.deployer-mnemonic');
fs.writeFileSync(mnemonicFile, walletInfo.mnemonic, { mode: 0o600 });
...
console.log('• BACKUP your mnemonic phrase in a secure location');
console.log('• This wallet is for TESTNET use only initially');

console.log('\n═══════════════════════════════════════════════════════════════════');
console.log('💡 WALLET BACKUP:');
console.log('═══════════════════════════════════════════════════════════════════\n');
console.log('Store this mnemonic phrase in a secure location:');
console.log(`"${walletInfo.mnemonic}"`);
console.log('\nYou can recover this wallet using the mnemonic phrase above.');
console.log('═══════════════════════════════════════════════════════════════════\n');
...
// Show QR code for easy mobile scanning (if address is short enough)
console.log('📱 WALLET ADDRESS (for easy copying):');
console.log('═══════════════════════════════════════════════════════════════════');
console.log(walletInfo.address);
console.log('═══════════════════════════════════════════════════════════════════\n');

console.log('✅ Deployer wallet creation complete!');
