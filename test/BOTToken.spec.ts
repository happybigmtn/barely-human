...
describe("BOTToken", function () {
  ...
  describe("Transfers", function () {
    it("Should allow regular transfers", async function () {
      const { botToken, treasury, user1, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
    ...
    it("Should allow approve and transferFrom", async function () {
      const { botToken, treasury, user1, user2, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
  ...
  describe("Pausable", function () {
    it("Should allow pauser to pause and unpause", async function () {
      const { botToken, deployer, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
    ...
    it("Should prevent transfers when paused", async function () {
      const { botToken, deployer, treasury, user1, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
  ...
  describe("Burn", function () {
    it("Should allow token holders to burn", async function () {
      const { botToken, treasury, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
  ...
  describe("Access Control", function () {
    it("Should allow admin to grant roles", async function () {
      const { botToken, deployer, user1, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
    ...
    it("Should allow admin to revoke roles", async function () {
      const { botToken, deployer, treasury, publicClient } = 
        await loadFixture(deployBOTTokenFixture);
