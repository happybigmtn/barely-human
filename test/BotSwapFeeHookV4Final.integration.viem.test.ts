...
async function main() {
  console.log("🧪 Running BotSwapFeeHookV4Final.integration Tests (Hardhat 3 + Viem)");
  ...
  try {
    ...
    let treasury: any;
    let stakingPool: any;
    let botswapfeehookv4final.integration: any;
    ...
    console.log("\n✅ All BotSwapFeeHookV4Final.integration tests passed!");
