...
contract BotSwapFeeHookV4Final is IHooks, AccessControl, ReentrancyGuard {
     ...
     */
    function toBeforeSwapDelta(int128 deltaAmount0, int128 deltaAmount1) internal pure returns (BeforeSwapDelta) {
        // Pack two int128s into int256 for BeforeSwapDelta (specified, unspecified)
        return BeforeSwapDelta.wrap(
            int256((int256(deltaAmount0) << 128) | int256(uint256(uint128(deltaAmount1))))
        );
    }
